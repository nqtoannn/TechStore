                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-p10b es-m-txt-c">
                                                                <h1 style="font-size:46px;line-height:46px">Đặt lại mật khẩu!</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-p15b">
                                                                <h3>Nếu bạn đã yêu cầu đặt lại mật khẩu, vui lòng truy cập liên kết bên dưới để đặt lại mật khẩu. Nếu không bạn có thể bỏ qua email này! </h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                <span class="es-button-border" style="border-radius:6px;border-color:#5c68e2;border-width:2px;background:#5c68e2">
                                                                    <a href="${url}" target="_blank" class="es-button" style="border-left-width:30px;border-right-width:30px;border-radius:6px">Đặt lại mật khẩu</a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
