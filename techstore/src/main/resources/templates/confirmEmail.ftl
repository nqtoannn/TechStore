                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-p15b">
                                                                <h3>Vui lòng truy cập liên kết bên dưới để xác minh tài khoản. Nếu không bạn có thể bỏ qua email này! </h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                <span class="es-button-border" style="border-radius:6px;border-color:#5c68e2;border-width:2px;background:#5c68e2">
                                                                    <a href="${url}" target="_blank" class="es-button" style="border-left-width:30px;border-right-width:30px;border-radius:6px">Xác nhận tài khoản</a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
